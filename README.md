...
| 4 | [`Secure Office Network with WAN Integration for a Financial Company`](./Secure-LAN-with-WAN-Integration) | Design and deployment of a secure, segmented LAN with WAN integration tailored for a financial institution’s office expansion. Emphasises security policy enforcement, scalability, and real-world topology implementation. |
